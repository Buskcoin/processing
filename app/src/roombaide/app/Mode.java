...
import roombaide.app.ui.EditorException;
import roombaide.app.ui.EditorState;
import roombaide.app.ui.ExamplesFrame;
import roombaide.app.ui.Recent;
import roombaide.app.ui.SketchbookFrame;
        ...
        if (pieces.length >= 2) {
          ...
          if (pieces.length == 3) {
            ...
            if (htmlFilename.length() > 0) {
              ...
              // https://github.com/roombaide/roombaide/issues/4224
...
//    }
   ...
   * For Roombaide, this is true for .pde files. (Broken out for subclasses.)
