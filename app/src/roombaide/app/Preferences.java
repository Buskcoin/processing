...
/*
  ...
  Copyright (c) 2014 The Roombaide Foundation
 ...
 * save sketch folders and locations. Like the rest of Roombaide, we use UTF8.
 * <p>
  ...
  static public void init() {
    ...
    try {
      ...
      Messages.showError(null, "Could not read default settings.\n" +
                         "You'll need to reinstall Roombaide.", e);
    }
...
//    if (firstRun) {
    ...
    if (get("proxy.system").equals("true")) {
      ...
      // https://github.com/roombaide/roombaide/issues/2643
  ...
  static public Font getFont(String attr) {
    try {
      ...
      if (!name.startsWith("roombaide.")) {
        return new Font(name, style, size);

      } else {
        if (pieces[0].equals("roombaide.sans")) {
          return Toolkit.getSansFont(size, style);
        } else if (pieces[0].equals("roombaide.mono")) {
