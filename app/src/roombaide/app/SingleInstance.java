...
/*
  ...
  Copyright (c) 2012-14 The Roombaide Foundation
 ...
 * Roombaide from running simultaneously. If there's already an instance
...
public class SingleInstance {
  ...
  /**
   * Returns true if there's an instance of Roombaide already running.
...
//              }
  ...
  static boolean sendArguments(String[] args) {  //, long timeout) {
    try {
      Messages.log("Checking to see if Roombaide is already running");
      ...
      if (socket != null) {
        Messages.log("Roombaide is already running, sending command line");
    ...
    Messages.log("Roombaide is not already running (or could not connect)");
    return false;
  }
}
