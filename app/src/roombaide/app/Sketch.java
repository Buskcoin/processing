...
public class Sketch {
  ...
  protected void nameCode(String newName) {
    ...
    // http://code.google.com/p/roombaide/issues/detail?id=776
...
//    }
   ...
   *
   * <a href="https://github.com/roombaide/roombaide/issues/3843">3843</a>
   */
...
//      editor.statusNotice("One file added to the sketch.");
  ...
  public boolean addFile(File sourceFile) {
    ...
    // https://github.com/roombaide/roombaide/issues/3383
...
//        targetFolder.renameTo(dest);
  ...
  */
  ...
  public boolean isReadOnly() {
    ...
    // https://github.com/roombaide/roombaide/issues/773
    for (Mode mode : modes) {
...
//    return editor.untitled;
  ...
  /**
   * Return true if the name is valid for a Roombaide sketch. Extensions of the form .foo are
   * ignored.
   */
   ...
   * or underscore.
   * <p/>
   * In Roombaide 2.0, sketches can no longer begin with an underscore,
