 ...
 * its version and the version of Java being used to run Roombaide.
 * <P>
 * Aside from the privacy invasion of knowing that an anonymous Roombaide
 ...
 * people are using Roombaide, which helps us when writing grant proposals
 * and that kind of thing so that we can keep Roombaide free. The numbers
...
//      boolean offerToUpdateContributions = true;
      ...
      if (latest > Base.getRevision()) {
        System.out.println("You are running Roombaide revision 0" +
