...
/*
  ...
  Copyright (c) 2013-16 The Roombaide Foundation
...
//          //status.setMessage("Restart Roombaide to finish the installation.");
//        }
   ...
   * the curated version from the Roombaide site. This ensures that things have
