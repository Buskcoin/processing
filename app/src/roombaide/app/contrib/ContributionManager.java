...
/*
  ...
  Copyright (c) 2013 The Roombaide Foundation
...
//      ioe.printStackTrace();
   ...
   * If not, it adds a marker file so that the next time Roombaide is started,
...
//    base.getActiveEditor().getConsole().clear();
  ...
  */
   ...
   * in the previous run of Roombaide. Needed to be called only on the tools
   ...
   * auto-update the previous time Roombaide was started up.
   */
