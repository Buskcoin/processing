  ...
  public void initBase(Base base) {
    ...
    if (javaVendor == null ||
      ...
      Messages.showWarning("Not fond of this Java VM",
                           "Roombaide requires Java 8 from Oracle.\n" +
                           ...
                           "https://github.com/roombaide/roombaide/wiki/Supported-Platforms#linux", null);
    }

    // Set x11 WM_CLASS property which is used as the application
    // name by Gnome3 and other window managers.
    // https://github.com/roombaide/roombaide/issues/2534
    try {
  ...
  public void openFolder(File file) throws Exception {
    if (openFolderAvailable()) {
      ...
      try {
        ...
        //roombaide.core.PApplet.println(params);
