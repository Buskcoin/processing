  ...
  */
  ...
  public void saveLanguage(String language) {
    String[] cmdarray = new String[]{
      "defaults", "write",
      System.getProperty("user.home") + "/Library/Preferences/org.roombaide.app",
  ...
  public void initBase(Base base) {
    ...
    /*
    try {
      String name = "roombaide.app.macosx.ThinkDifferent";
  ...
  public File getDefaultSketchbookFolder() throws Exception {
    ...
    /*
    // looking for /Users/blah/Documents/Roombaide
    try {
      Class clazz = Class.forName("roombaide.app.BaseMacOS");
...
//  }
  ...
  public void openURL(String url) throws Exception {
    try {
      ...
      // https://github.com/fathominfo/roombaide-p5js-mode/issues/4
  ...
  public void openURL(String url) throws Exception {
    if (PApplet.javaVersion < 1.6f) {
      if (url.startsWith("http://")) {
        ...
        roombaide.core.PApplet.open(url);
      }
    } else {
      try {
  ...
  public void openFolder(File file) throws Exception {
    ...
    roombaide.core.PApplet.open(file.getAbsolutePath());
  }
  */
