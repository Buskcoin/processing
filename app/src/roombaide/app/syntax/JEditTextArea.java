...
import roombaide.app.syntax.im.InputMethodSupport;
 ...
 * for use with Roombaide (notably mouse wheel support and copyAsHTML). [fry]
 * <p>
...
//            System.out.println("  " + e);
  ...
  public void updateScrollBars() {
    ...
    if ((horizontal != null) && (painter.getWidth() != 0)) {
      ...
      // http://code.google.com/p/roombaide/issues/detail?id=280
      // http://code.google.com/p/roombaide/issues/detail?id=316
...
//    }
  ...
  public void copyAsHTML() {
    ...
    Clipboard clipboard = roombaide.app.ui.Toolkit.getSystemClipboard();
...
//    System.out.println("focus owner is: " + isFocusOwner());
    if (editable) {
      ...
      try {
        ...
        // http://code.google.com/p/roombaide/issues/detail?id=69
        if (selection.contains("\t")) {
        ...
        // https://github.com/roombaide/roombaide/issues/1973
...
//  public EditorLineStatus editorLineStatus;
  ...
  public void processKeyEvent(KeyEvent evt) {
    // this had to be added in Roombaide 007X, because the menu key
