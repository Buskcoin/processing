...
public class PdeInputHandler extends DefaultInputHandler {
   ...
   * will want a local copy anyway. Changed after Roombaide 3.1.2, need to
  ...
  public PdeInputHandler() {
    ...
    if (Platform.isMacOS()) {
      ...
      // http://code.google.com/p/roombaide/issues/detail?id=1354
  ...
  public void keyPressed(KeyEvent event) {
    ...
    // https://github.com/roombaide/roombaide/issues/3074
