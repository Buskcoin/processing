...
////    if (Preferences.get("editor.font").startsWith("roombaide.mono")) {
////      return roombaide.app.Toolkit.getMonoFont(size, style);
////    } else {
...
//      String psName =
//        roombaide.app.Toolkit.getMonoFont(size, style).getPSName();
//      int dash = psName.indexOf('-');
//      monoFontFamily = psName.substring(0, dash);
//
//      // Just get the font family name for comparison
//      //monoFontFamily =
//        //roombaide.app.Toolkit.getMonoFont(size, style).getFamily();
//      //roombaide.app.Toolkit.getMonoFont(size, style).getFamily();
//      Font mono = roombaide.app.Toolkit.getMonoFont(size, style);
