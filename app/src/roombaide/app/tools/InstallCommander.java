...
/*
  ...
  Copyright (c) 2012 The Roombaide Foundation
...
import roombaide.app.ui.Editor;
...
public class InstallCommander implements Tool {
  ...
  public String getMenuTitle() {
    return Language.text("menu.tools.install_roombaide_java");
  }
  ...
  public void run() {
    try {
      ...
      final String primary =
        "Install roombaide-java for all users?";
      final String secondary =
        "This will install the roombaide-java program, which is capable " +
        ...
        "If you rename or move Roombaide.app, " +
      ...
      writer.print("# Prevents roombaide-java from stealing focus, see:\n" +
                   "# https://github.com/roombaide/roombaide/issues/3996.\n" +
      ...
      if (result == JOptionPane.YES_OPTION) {
        ...
        // https://github.com/roombaide/roombaide/issues/3497
        String targetPath = "/usr/local/bin/roombaide-java";
        // Remove the old version in case it exists
        // https://github.com/roombaide/roombaide/issues/3786
        String oldPath = "/usr/bin/roombaide-java";
        ...
        File targetFile = new File(System.getProperty("user.home"), "roombaide-java");
        String targetPath = targetFile.getAbsolutePath();
        if (targetFile.exists()) {
          Messages.showWarning("File Already Exists",
                               "The roombaide-java program already exists at:\n" +
                               targetPath + "\n" +
