...
/**
 * Main editor panel for the Roombaide Development Environment.
 */
...
//  private JMenuItem saveAsMenuItem;
  ...
  protected Editor(final Base base, String path, final EditorState state,
    ...
    super("Roombaide", state.checkConfig());
    this.base = base;
    this.state = state;
    this.mode = mode;
    ...
    // This is a Roombaide window. Get rid of that ugly ass coffee cup.
...
//    box.setOpaque(false);
  ...
  */
  ...
  // https://github.com/roombaide/roombaide/issues/2615
...
//  }
  ...
  protected JMenu buildEditMenu() {
    ...
    // http://code.google.com/p/roombaide/issues/detail?id=363
    ...
    item.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          ...
          // https://github.com/roombaide/roombaide/issues/3457
...
//    final Editor editorName = this;
  ...
  */
  ...
  protected JMenu addInternalTools(JMenu menu) {
    addToolMenuItem(menu, "roombaide.app.tools.CreateFont");
    addToolMenuItem(menu, "roombaide.app.tools.ColorSelector");
    addToolMenuItem(menu, "roombaide.app.tools.Archiver");

    if (Platform.isMacOS()) {
      addToolMenuItem(menu, "roombaide.app.tools.InstallCommander");
    }
  ...
  item.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
          public void run() {
            try {
              int port = WebServer.launch("/Users/fry/coconut/roombaide/build/shared/reference.zip");
  ...
  */
  ...
  item.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        BrowserStartup bs = new BrowserStartup("jar:file:/Users/fry/coconut/roombaide/build/shared/reference.zip!/reference/setup_.html");
        bs.initUI();
        bs.launch();
      }
    });
  ...
  */
  ...
  static public void showChanges() {
    // http://code.google.com/p/roombaide/issues/detail?id=1520
    if (!Base.isCommandLine()) {
      Platform.openURL("https://github.com/roombaide/roombaide/wiki/Changes");
    }
  }
...
//  }
  ...
  public void startCompoundEdit() {
    ...
    // https://github.com/roombaide/roombaide/issues/3003
...
//        textarea.getSelectionStopLine() < textarea.getLastLine();
      ...
      if (formattedText.equals(source)) {
        ...
        // http://code.google.com/p/roombaide/issues/detail?id=1533
...
//  }
  ...
  public boolean checkModified() {
    ...
    // As of Roombaide 1.0.10, this always happens immediately.
...
//    untitled = false;
   ...
   * something like "sketch_070752a - Roombaide 0126"
   */
  public void updateTitle() {
    setTitle(sketch.getName() + " | Roombaide " + Base.getVersionName());
