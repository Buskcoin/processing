...
import roombaide.app.ui.ColorChooser;
...
public class PreferencesFrame {
  ...
  public PreferencesFrame(Base base) {
    ...
    // Language: [ English ] (requires restart of Roombaide)
    ...
    // Interface scale: [ 100% ] (requires restart of Roombaide)
    ...
    // [ ] Automatically associate .pde files with Roombaide
    ...
    // https://github.com/roombaide/roombaide/issues/3212
