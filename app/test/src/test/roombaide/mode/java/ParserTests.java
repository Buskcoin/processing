...
import static test.roombaide.mode.java.RoombaideTestUtil.COMPILER;
import static test.roombaide.mode.java.RoombaideTestUtil.preprocess;
...
import roombaide.app.exec.ProcessResult;
...
public class ParserTests {
  ...
  static void expectCompilerException(final String id,
                                      ...
                                      final int expectedLine) {
    try {
      final String program = RoombaideTestUtil
          .preprocess(id, res(id + ".pde"));
  ...
  static void expectGood(final String id) {
    try {
      ...
      if (expectedFile.exists()) {
        final String expected = RoombaideTestUtil.read(expectedFile);
        ...
        sug.write(RoombaideTestUtil.normalize(program));
        sug.close();
      }
