...
//        g2 = (Graphics2D) canvas.getGraphics();
        ...
        if (useOffscreen) {
          ...
          // http://code.google.com/p/roombaide/issues/detail?id=729
...
//      image = gc.createCompatibleVolatileImage(wide, high);
  ...
  public void beginDraw() {
    ...
    // https://github.com/roombaide/roombaide/issues/3331
    if (strokeObject != null) {
      g2.setStroke(strokeObject);
    }
    // https://github.com/roombaide/roombaide/issues/2617
    if (fontObject != null) {
      g2.setFont(fontObject);
    }
    // https://github.com/roombaide/roombaide/issues/4019
    if (blendMode != 0) {
      blendMode(blendMode);
    }
    handleSmooth();
...
//    }
  ...
  public void hint(int which) {
    ...
    // http://code.google.com/p/roombaide/issues/detail?id=1068
    // Unfortunately cannot always be enabled, because it makes the
    // stroke in many standard Roombaide examples really gross.
...
//    smooth = false;
//    quality = 0;  // https://github.com/roombaide/roombaide/issues/3113
//    g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING,
//                        RenderingHints.VALUE_ANTIALIAS_OFF);
//    g2.setRenderingHint(RenderingHints.KEY_INTERPOLATION,
//                        RenderingHints.VALUE_INTERPOLATION_NEAREST_NEIGHBOR);
  ...
  protected void imageImpl(PImage who,
    ...
    if (who.isModified()) {
      if (who.pixels == null) {
        ...
        // https://github.com/roombaide/roombaide/issues/2208
...
//      }
      ...
      // https://github.com/roombaide/roombaide/issues/2030
      if (image == null) {
...
//      g2.fillRect(0, 0, width, height);
  ...
  protected WritableRaster getRaster() {
    ...
    // the rest of the Roombaide source.
    // https://github.com/roombaide/roombaide/issues/2010
    if (raster.getTransferType() != DataBuffer.TYPE_INT) {
      System.err.println("See https://github.com/roombaide/roombaide/issues/2010");
