...
/*
  ...
  Copyright (c) 2014-15 The Roombaide Foundation
...
import roombaide.core.PGraphics;
import roombaide.core.PImage;
import roombaide.core.PSurfaceNone;
import roombaide.event.KeyEvent;
import roombaide.event.MouseEvent;
    ...
    canvas.addComponentListener(new ComponentAdapter() {
      ...
      public void componentResized(ComponentEvent e) {
        if (!sketch.isLooping()) {
          ...
          // https://github.com/roombaide/roombaide/issues/3310
...
//        // http://code.google.com/p/roombaide/issues/detail?id=258
//        //        requestFocus();
//
//        // Changing to this version for 0187
//        // http://code.google.com/p/roombaide/issues/detail?id=279
...
//    System.out.println("display from sketch is " + displayNum);
    ...
    // https://github.com/roombaide/roombaide/issues/3545
    /*
    ...
    */
    ...
    // https://github.com/roombaide/roombaide/issues/1955
    frame = new JFrame(displayDevice.getDefaultConfiguration());
//    frame = new Frame(displayDevice.getDefaultConfiguration());
//    // Default Roombaide gray, which will be replaced below if another
...
//    }
    ...
    if (fullScreen) {
      ...
      // https://github.com/roombaide/roombaide/pull/3162
...
//      frame.pack();
    ...
    // http://code.google.com/p/roombaide/issues/detail?id=467
...
//  }
  ...
  public void setTitle(String title) {
    ...
    // https://github.com/roombaide/roombaide/issues/3472
    if (cursorVisible &&
  ...
  protected void setRoombaideIcon(Frame frame) {
  ...
  public void setVisible(boolean visible) {
    ...
    // removing per https://github.com/roombaide/roombaide/pull/3162
  ...
  private void setupFrameResizeListener() {
    frame.addWindowStateListener(new WindowStateListener() {
      ...
      public void windowStateChanged(WindowEvent e) {
        ...
        // https://github.com/roombaide/roombaide/issues/3092
...
//  }
  ...
  */
  ...
  protected void nativeMouseEvent(java.awt.event.MouseEvent nativeEvent) {
    ...
    // http://code.google.com/p/roombaide/issues/detail?id=1294
    // The fix for which led to a regression (fixed here by checking both):
    // http://code.google.com/p/roombaide/issues/detail?id=1332
    int peButton = 0;
...
//  }
  ...
  public void setCursor(int kind) {
    ...
    // https://github.com/roombaide/roombaide/issues/2358
