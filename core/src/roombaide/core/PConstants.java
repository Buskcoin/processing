...
/**
 * Numbers shared throughout roombaide.core.
 * <P>
...
public interface PConstants {
  ...
  // renderers known to roombaide.core
  ...
  */
  ...
  static final String JAVA2D = "roombaide.awt.PGraphicsJava2D";

  static final String P2D = "roombaide.opengl.PGraphics2D";
  static final String P3D = "roombaide.opengl.PGraphics3D";
...
//  static final String E2D = PGraphicsDanger2D.class.getName();
  ...
  static final String FX2D = "roombaide.javafx.PGraphicsFX2D";

  static final String PDF = "roombaide.pdf.PGraphicsPDF";
  static final String SVG = "roombaide.svg.PGraphicsSVG";
  static final String DXF = "roombaide.dxf.RawDXF";
...
//  static final int CMYK  = 5;  // image & color (someday)
  ...
  // @see roombaide.core.PImage#blendColor(int,int,int)
