...
/**
 * Grayscale bitmap font class used by Roombaide.
 * <P>
...
//  protected HashMap<PGraphics, Object> cacheMap;
   ...
   *
   * PFont is the font class for Roombaide. To create a font to use with
   * Roombaide, select "Create Font..." from the Tools menu. This will
   * create a font in the format Roombaide requires and also adds it to the
   * current sketch's data directory. Roombaide displays fonts using the
  ...
  public PFont(Font font, boolean smooth, char charset[]) {
    ...
    // These values are terrible/unusable. Verified again for Roombaide 1.1.
...
//      PApplet.println(iterPoints);
  ...
  /**
   * The default Roombaide character set.
   * <P>
   ...
   * into <b>createFont()</b>, which allows Roombaide to dynamically format
