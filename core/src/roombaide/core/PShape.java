 ...
 *
 * Datatype for storing shapes. Roombaide can currently load and display
 ...
 * after the release of Roombaide 1.0. Such changes may include:
 *
 * <ul>
 ...
 * package roombaide.shape (if the code grows too much).
 * </ul>
 *
...
//  static public final int GROUP = 0;
  ...
  // https://github.com/roombaide/roombaide/issues/3776
...
//      shapeCreated = true;
   ...
   *
   * Disables the shape's style data and uses Roombaide's current styles.
   ...
   * @webref pshape:method
   * @usage web_application
   * @brief     Disables the shape's style data and uses Roombaide styles
   ...
   *
   * Enables the shape's style data and ignores Roombaide's current styles.
   * Styles include attributes such as colors, stroke weight, and stroke
   * joints.
   *
   * ( end auto-generated )
   ...
   * @webref pshape:method
   * @usage web_application
   * @brief Enables the shape's style data and ignores the Roombaide styles
...
//      drawPath(g);
  ...
  */
  ...
  protected void crop() {
    // https://github.com/roombaide/roombaide/issues/3347
