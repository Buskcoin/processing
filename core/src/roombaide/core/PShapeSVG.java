...
/**
 * This class is not part of the Roombaide API and should not be used
 ...
 * when combined with future versions of Roombaide.
 * <p>
 ...
 * <p>
 * Batik is used in the SVG Export library in Roombaide 3, however using it
...
//    char prevCommand = '\0';
    ...
    while (i < pathTokens.length) {
      ...
      case 'z':
        ...
        // http://code.google.com/p/roombaide/issues/detail?id=1058
        cx = movetoX;
        cy = movetoY;
        close = true;
        i++;
