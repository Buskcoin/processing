...
import roombaide.core.PSurface;
...
//    pgl.reqNumSamples = PGL.smoothToSamples(graphics.smooth);
  ...
  protected void initWindow() {
    ...
    // https://github.com/roombaide/roombaide/issues/4690
...
//    }
    ...
    /*
    // Trying to fix
    // https://github.com/roombaide/roombaide/issues/3401
  ...
  class DrawListener implements GLEventListener {
    public void display(GLAutoDrawable drawable) {
      if (display.getEDTUtil().isCurrentThreadEDT()) {
        ...
        // EDT, skipping rendering Roombaide's frame in that case.
        return;
      }
...
//      System.out.println("exit");
  ...
  protected void nativeMouseEvent(com.jogamp.newt.event.MouseEvent nativeEvent,
    ...
    if (peAction == MouseEvent.WHEEL) {
      ...
      // https://github.com/roombaide/roombaide/issues/3840
