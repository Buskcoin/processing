...
void main() {
  ...
  // the line to disappear, see https://github.com/roombaide/roombaide/issues/5183)
  // t = screen_q - screen_p
  //
  ...
  //  and corrects for aspect ratio, see https://github.com/roombaide/roombaide/issues/5181)
  ...
  // to get the right thickness (see https://github.com/roombaide/roombaide/issues/5182)
  // invert Y, projections in Roombaide invert Y
