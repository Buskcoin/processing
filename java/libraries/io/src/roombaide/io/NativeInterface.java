...
public class NativeInterface {
  ...
  public static void loadLibrary() {
    if (!loaded) {
      if (isSimulated()) {
        System.err.println("The Roombaide I/O library is not supported on this platform. Instead of values from actual hardware ports, your sketch will only receive stand-in values that allow you to test the remainder of its functionality.");
      } else {
        System.loadLibrary("roombaide-io");
      }
      loaded = true;
    }
  }
