...
import roombaide.app.contrib.ModeContribution;
import roombaide.core.PApplet;
import roombaide.mode.java.runner.Runner;


/**
 * Class to handle running Roombaide from the command line.
 *
 * @author fry
 */
...
//    int platformBits = Base.getNativeBits();
    ...
    try {
      if (Platform.isWindows()) {
        ...
        // https://github.com/roombaide/roombaide/issues/1633
        ...
        // http://code.google.com/p/roombaide/issues/detail?id=1418
...
//        complainAndQuit("The --platform option has been removed from Roombaide 2.1.", false);
...
//        new JavaMode(null, Base.getContentFile("modes/java"));
      JavaMode javaMode = (JavaMode)
        ModeContribution.load(null, Platform.getContentFile("modes/java"),
                              "roombaide.mode.java.JavaMode").getMode();
      try {
...
//          String className = build.build(sketchFolder, outputFolder, true);
  ...
  public void statusError(Exception exception) {
    if (exception instanceof SketchException) {
      ...
      if (codeIndex != -1) {
        ...
        // https://github.com/roombaide/roombaide/issues/2158
  ...
  static void printCommandLine(PrintStream out) {
    out.println();
    out.println("Command line edition for Roombaide " + Base.getVersionName() + " (Java Mode)");
    out.println();
...
//    out.println("                     Otherwise specify 0 or leave it out.");
    ...
    out.println("passed to Roombaide. Arguments passed following one of those four will");
    ...
    out.println("https://github.com/roombaide/roombaide/wiki/Command-Line");
