...
//            System.out.println("'" + m[1] + "'");
            if (m[1].equals("roombaide.xml")) {
              exception.setMessage("roombaide.xml no longer exists, this code needs to be updated for 2.0.");
              System.err.println("The roombaide.xml library has been replaced " +
          ...
          if (what.equals("BFont") ||
            ...
            if (suggestion != null) {
              ...
              System.err.println("To make sketches more portable, imports that are not part of the Roombaide API were removed in Roombaide 2.");
              System.err.println("See the changes page for more information: https://github.com/roombaide/roombaide/wiki/Changes");
            }
          }
