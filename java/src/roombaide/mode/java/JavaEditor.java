...
import roombaide.app.*;
import roombaide.app.contrib.*;
import roombaide.app.syntax.JEditTextArea;
import roombaide.app.syntax.PdeTextAreaDefaults;
import roombaide.app.ui.*;
import roombaide.app.ui.Toolkit;
import roombaide.mode.java.debug.LineBreakpoint;
import roombaide.mode.java.debug.LineHighlight;
import roombaide.mode.java.debug.LineID;
import roombaide.mode.java.pdex.PreroombaideService;
import roombaide.mode.java.pdex.ImportStatement;
import roombaide.mode.java.pdex.JavaTextArea;
import roombaide.mode.java.pdex.PDEX;
import roombaide.mode.java.pdex.JavaProblem;
import roombaide.mode.java.pdex.SourceUtils;
import roombaide.mode.java.preproc.PdePreprocessor;
import roombaide.mode.java.runner.Runner;
import roombaide.mode.java.tweak.ColorControlBox;
import roombaide.mode.java.tweak.Handle;
import roombaide.mode.java.tweak.SketchParser;
import roombaide.mode.java.tweak.TweakClient;
...
public class JavaEditor extends Editor {
  ...
  protected PreroombaideService preroombaideService;
  protected PDEX pdex;
  ...
  protected JavaEditor(Base base, String path, EditorState state,
    ...
    */
    ...
    preroombaideService = new PreroombaideService(this);
    pdex = new PDEX(this, preroombaideService);
  ...
  public EditorHeader createHeader() {
    return new EditorHeader(this) {
      public void rebuild() {
        ...
        if (preroombaideService != null) {
          if (hasJavaTabsChanged) {
            preroombaideService.handleHasJavaTabsChange(hasJavaTabs);
      ...
      public void actionPerformed(ActionEvent e) {
        try {
          ...
          Messages.showWarning("Unwelcome Error",
                               ...
                               "https://github.com/roombaide/roombaide/issues", ioe);
        }
      }
    });
    menu.add(item);
...
//      "<html><body><font size=2>" +
    ...
    if (Platform.isMacOS()) {
      ...
      String thePain =
        ...
        "which makes it more difficult to run applications like those exported from Roombaide. ";
...
//  }
  ...
  public void handleRun() {
    if (isDebuggerEnabled()) {
      ...
      // https://github.com/roombaide/roombaide/issues/3623
      if (debugger.isStarted()) {
        debugger.stopDebug();
      }
      // Don't start the sketch paused, continue until a breakpoint or error
      // https://github.com/roombaide/roombaide/issues/3096
...
//      sb.append(list[i]);
  ...
  public void librariesChanged() {
    preroombaideService.notifyLibrariesChanged();
  }


  @Override
  public void codeFolderChanged() {
    preroombaideService.notifyCodeFolderChanged();
  }


  @Override
  public void sketchChanged() {
    preroombaideService.notifySketchChanged();
  }
...
//  }
  ...
  public PreroombaideService getPreroombaideService() {
    return preroombaideService;
  }
