...
import roombaide.mode.java.debug.VariableNode;
...
public class VariableInspector extends JDialog {
  ...
  /// node for Roombaide built-in variables
  ...
  */
  ...
  Container createScrollPane() {
    ...
    */
    ...
    builtins = new DefaultMutableTreeNode("Roombaide");
...
//  }
  ...
  */
  ...
  /**
   * A {@link VariableNodeFilter} that accepts Roombaide built-in variable
   * names.
   */
