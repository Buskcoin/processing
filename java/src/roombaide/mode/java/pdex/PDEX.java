...
import roombaide.app.syntax.SyntaxDocument;
import roombaide.app.ui.EditorStatus;
import roombaide.app.ui.Toolkit;
import roombaide.app.ui.ZoomTreeCellRenderer;
import roombaide.mode.java.JavaEditor;
import roombaide.mode.java.JavaMode;
import roombaide.mode.java.pdex.PreprocessedSketch.SketchInterval;

import static roombaide.mode.java.pdex.ASTUtils.*;
...
public class PDEX {
  ...
  private PreroombaideService pps;


  public PDEX(JavaEditor editor, PreroombaideService pps) {
    this.pps = pps;
  ...
  private class InspectMode {
    ...
    JavaEditor editor;
    PreroombaideService pps;

    InspectMode(JavaEditor editor, PreroombaideService pps) {
      this.editor = editor;
      this.pps = pps;
  ...
  static private class ShowUsage {
    ...
    ShowUsage(JavaEditor editor, PreroombaideService pps) {
      this.editor = editor;
      this.pps = pps;
  ...
  private class Rename {
    ...
    Rename(JavaEditor editor, PreroombaideService pps) {
      this.editor = editor;
      this.pps = pps;
  ...
  static private class DebugTree {
    ...
    DebugTree(JavaEditor editor, PreroombaideService pps) {
  ...
  static private class ErrorChecker {
    ...
    public ErrorChecker(JavaEditor editor, PreroombaideService pps) {
      this.editor = editor;
      this.pps = pps;
