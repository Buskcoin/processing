...
/**
 * Class that orchestrates preroombaide p5 syntax into straight Java.
 * <P/>
...
//    "(?:^|\\s|;)void\\s";
  ...
  // http://code.google.com/p/roombaide/issues/detail?id=551
...
*/
  ...
  static public String scrubComments(String what) {
    ...
    // http://code.google.com/p/roombaide/issues/detail?id=1435
    boolean insideQuote = false;
...
//    System.out.println(program);
  ...
  private String write(final String program, final PrintWriter stream)
    ...
    // http://code.google.com/p/roombaide/issues/detail?id=1404
...
//          out.print("\"" + PApplet.ARGS_BGCOLOR + "=" + farbe + "\", ");
   ...
   * for packages like roombaide.xml which no longer exist.
   * @param pkg something like roombaide.xml.XMLElement or roombaide.xml.*
   * @return true if this shouldn't be added to the final code
   */
  public boolean ignoreImport(String pkg) {
    return false;
//    return pkg.startsWith("roombaide.xml.");
  }
